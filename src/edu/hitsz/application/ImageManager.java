...
public class ImageManager {
    ...
    public static BufferedImage BULLETPROP_PRO_IMAGE;

    public static BufferedImage BULLETPLUSPROP_PRO_IMAGE;
    ...
    static {
        try {
            ...
            BULLETPROP_PRO_IMAGE = ImageIO.read(new FileInputStream("src/images/prop_bullet.png"));
            BULLETPLUSPROP_PRO_IMAGE = ImageIO.read(new FileInputStream("src/images/prop_bulletPlus.png"));
            ...
            CLASSNAME_IMAGE_MAP.put(Blood.class.getName(), BLOOD_PROP_IMAGE);
            CLASSNAME_IMAGE_MAP.put(Bomb.class.getName(), BOMB_PROP_IMAGE);
            CLASSNAME_IMAGE_MAP.put(BulletProp.class.getName(), BULLETPROP_PRO_IMAGE);
            CLASSNAME_IMAGE_MAP.put(BulletPlusProp.class.getName(), BULLETPLUSPROP_PRO_IMAGE);
